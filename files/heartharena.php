...
$pala = 0;
$npala = 0;
$query = "SELECT PALA FROM votehearth";
...
$drui = 0;
$ndrui = 0;
$query = "SELECT DRUI FROM votehearth";
$result = mysqli_query($GLOBALS['con'], $query);
...
$mage = 0;
$nmage = 0;
$query = "SELECT MAGE FROM votehearth";
$result = mysqli_query($GLOBALS['con'], $query);
...
$warl = 0;
$nwarl = 0;
$query = "SELECT WARL FROM votehearth";
$result = mysqli_query($GLOBALS['con'], $query);
...
$sham = 0;
$nsham = 0;
$query = "SELECT SHAM FROM votehearth";
$result = mysqli_query($GLOBALS['con'], $query);
...
$warr = 0;
$nwarr = 0;
$query = "SELECT WARR FROM votehearth";
$result = mysqli_query($GLOBALS['con'], $query);
...
$prie = 0;
$nprie = 0;
$query = "SELECT PRIE FROM votehearth";
$result = mysqli_query($GLOBALS['con'], $query);
...
$rogu = 0;
$nrogu = 0;
$query = "SELECT ROGU FROM votehearth";
$result = mysqli_query($GLOBALS['con'], $query);
...
$hunt = 0;
$nhunt = 0;
$query = "SELECT HUNT FROM votehearth";
$result = mysqli_query($GLOBALS['con'], $query);
...
<div id = "comment">
<?php
$query = "SELECT NAME, COMMENT FROM commentarena";
$result = mysqli_query($GLOBALS['con'], $query);
?>
<body>
	<h1>Comment</h1>
    
     <form name="addComment" action="commentarena.php" method="post" target = "iframe_a">
    
    Comment: <input type="text" name="comment"><br/><br/>
    <input type="submit" value="Add">
    </form>
</body>
<iframe width="100%" height="300px" src="commentarena.php" name="iframe_a"></iframe>
