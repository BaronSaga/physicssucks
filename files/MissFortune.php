...
<body>
	<h1>Comment</h1>
     ...
     <form name="addComment" action="MissFortune.php" method="post">
...
if(isset($_POST["comment"]))
{
	...
	//Add user
	addCommentMissFortune($u, $p);
	
}
?>
    <iframe width="100%" height="300px" src="commentMissFortune.php" name="iframe_a"></iframe>
</body>

</div>
<div id="section">
<h1><img src = "images/mfN.png" height ="68px" width = "207px"/></h1>
<img src = "images/MissFortune.jpg" height ="358.5px" width = "607.5px"/>
<h2>Skills</h2>
<h3><img src = "images/MissFortuneViciousStrikes.png" height = "35px" width= "35px"/> - Passive - Love Tap</h3>
Miss Fortune deals bonus physical damage whenever she attacks a new target. </br>

<h3><img src = "images/MissFortuneRicochetShot.png" height = "35px" width= "35px"/> - Q - Double Up </br></h3>
Cost: 43/46/49/52/55 Mana </br>
Range: 650 </br> </br>
Miss Fortune fires a bullet at an enemy, damaging them and a target behind them. Both strikes can also apply Love Tap. 
</br> 

<h3><img src = "images/MissFortune_W.png" height = "35px" width= "35px"/> - W - Strut </br></h3>
Cost: 80 Mana </br>
Range: 1000 </br> </br>
Miss Fortune passively gains Movement Speed when not attacked. This ability can be activated to grant bonus Attack Speed for a duration that prolongs with successive Love Taps. 
